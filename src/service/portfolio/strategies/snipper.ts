...
export async function snipperON(ctx: any, amount: number) {
  try {
...
export async function setSnipe(ctx: any, amountIn: number) {
  ...
  const amountInLamports = new BigNumber(amountIn).times(1e9);
